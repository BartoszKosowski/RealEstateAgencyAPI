...
namespace RealEstateAgencyAPI.Controllers
{
    ...
    public class AgentsController : ControllerBase
    {
        ...
        public AgentsController(estate_agency_dbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Agent>> PostAgent(Agent agent)
        {
            ...
            return CreatedAtAction("GetAgent", new { id = agent.IdAgents }, agent);
        }
        ...
        {
            return _context.Agents.Any(e => e.IdAgents == id);
        }
    }
}
