...
namespace RealEstateAgencyAPI.Migrations
{
    ...
    [Migration("20220103173439_26_RemoveDistanceToLocationsFromApartmentOfferView")]
    partial class _26_RemoveDistanceToLocationsFromApartmentOfferView
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RealEstateAgencyAPI.Models.Apartment", b =>
                {
                    ...
                    b.Property<string>("InsideDesign")
                        .HasColumnType("varchar(100)")
            ...
            modelBuilder.Entity("RealEstateAgencyAPI.Models.ApartmentOffer", b =>
                {
                    ...
                    b.ToView("apartment_offer_view");
                });

            modelBuilder.Entity("RealEstateAgencyAPI.Models.ApartmentOfferPreview", b =>
                {
                    b.Property<int>("Agent")
                        .HasColumnType("int")
                        .HasColumnName("agent");
                    ...
                    b.ToView("apartment_offer_preview_view");
                });
            ...
            modelBuilder.Entity("RealEstateAgencyAPI.Models.EstateOffer", b =>
                {
                    b.Property<int?>("Agent")
                        .HasColumnType("int")
                        .HasColumnName("agent");
                    ...
                    b.Property<bool?>("GasInstallation")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("gas_installation");
                    ...
                    b.ToView("estate_offer_view");
                });

            modelBuilder.Entity("RealEstateAgencyAPI.Models.EstateOfferPreview", b =>
                {
                    b.Property<int>("Agent")
                        .HasColumnType("int")
                        .HasColumnName("agent");
                    ...
                    b.ToView("estate_offer_preview_view");
                });
            ...
            modelBuilder.Entity("RealEstateAgencyAPI.Models.Offer", b =>
                {
                    ...
                    b.Property<bool?>("IsEstate")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("is_estate");
